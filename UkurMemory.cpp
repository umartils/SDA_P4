...
void ukurMemoriLinkedList() {
    ...
    cout << "Penggunaan memori Linked List dengan Struct: " << totalMemory << " bytes" << endl;
}
...
void cetakArray(){
    ...
    cout << endl << "08. Menambahkan node pada posisi akhir:" << endl;
    masukanElemenKeAkhir("Khuldi", "Merah", 2.1, 13000, "unKown");
    cetakSingleArray();
}
